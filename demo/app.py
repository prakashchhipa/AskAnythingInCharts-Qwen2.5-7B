...
This demo showcases a vision-language model fine-tuned specifically for chart understanding
on the ChartQA dataset. Compare the base model with the fine-tuned version side-by-side!
"""
...
ADAPTER_PATH = "outputs/qwen2_5_vl_7b_sft_chart_text_oct15_e2"  # Update this path
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"

# Load example data (hand-picked curated examples)
